...
class DynamixelMotorsBus:
        ...
        for i, name in enumerate(motor_names):
            ...
            if CalibrationMode[calib_mode] == CalibrationMode.DEGREE:
                ...
                if (values[i] < LOWER_BOUND_DEGREE) or (values[i] > UPPER_BOUND_DEGREE):
                    #print("dynamixel non-correction result:",values)
                    raise JointOutOfRangeError(
                        f"Wrong motor position range detected for dynamixel: {name}. "
    ...
    def read(self, data_name, motor_names: str | list[str] | None = None):
        ...
        #print("dynamixel original read",data_name,values)
        ...
        #print("dynamixel calibrated read",data_name,values)
        return values
    ...
    def write(self, data_name, values: int | float | np.ndarray, motor_names: str | list[str] | None = None):
        ...
        #print("dynamixel original write",data_name,values)
        ...
        #print("dynamixel reverted write",data_name,values)
