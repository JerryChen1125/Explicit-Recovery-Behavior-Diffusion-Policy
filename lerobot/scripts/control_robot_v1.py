...
import dill
import hydra
from lerobot.CFG_diffusion_policy.diffusion_policy.diffusion_policy.workspace.base_workspace import BaseWorkspace
from lerobot.CFG_diffusion_policy.diffusion_policy.diffusion_policy.policy.base_image_policy import BaseImagePolicy
from lerobot.CFG_diffusion_policy.diffusion_policy.diffusion_policy.policy.error_aware_policy import error_aware_policy
import sys
import os
cfd_policy_path = "/home/sealab/jr_code/lerobot/lerobot/CFG_diffusion_policy/diffusion_policy"
sys.path.insert(0, cfd_policy_path)

########################################################################################
# Control modes
########################################################################################
def load_policy():
    ckpt_path = "/home/sealab/task1_yuan_training/checkpoints/latest.ckpt"
    ...
    vae_ckpt="/media/sealab/data/policy/task1_errordetector/checkpoints/latest.ckpt"
