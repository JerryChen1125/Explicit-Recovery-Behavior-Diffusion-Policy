...
import sys
sys.path.append('/home/sealab/CFG_diffusion_policy/diffusion_policy/diffusion_policy/robomimic')
import torch
import torch.nn as nn
import torch.nn.functional as F
import torch.distributions as D

import diffusion_policy.robomimic.utils.loss_utils as LossUtils
import diffusion_policy.robomimic.utils.tensor_utils as TensorUtils
import diffusion_policy.robomimic.utils.torch_utils as TorchUtils
from diffusion_policy.robomimic.models.base_nets import Module
from diffusion_policy.robomimic.models.obs_nets import MIMO_MLP
...
class VAE(torch.nn.Module):
    ...
    def __init__(
        ...
        self.latent_clip = latent_clip
        self.device = device
        input_shapes=OrderedDict(input_shapes)
        output_shapes=OrderedDict(output_shapes)
