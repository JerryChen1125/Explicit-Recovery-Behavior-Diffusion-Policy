...
try:
    from diffusion_policy.robomimic.macros_private import *
except ImportError:
    from diffusion_policy.robomimic.utils.log_utils import log_warning
    import diffusion_policy.robomimic
    log_warning(
        "No private macro file found!"\
        "\nIt is recommended to use a private macro file"\
        "\nTo setup, run: python {}/scripts/setup_macros.py".format(diffusion_policy.robomimic.__path__[0])
    )
